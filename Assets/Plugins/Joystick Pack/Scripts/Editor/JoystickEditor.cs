...
public class JoystickEditor : Editor
{
    ...
    {
        m_ControlPath = serializedObject.FindProperty("m_ControlPath");
    ...
    {
        EditorGUILayout.PropertyField(m_ControlPath, new GUIContent("Control Path", "Which control this joystick is representing"));
